    ...
    <div class="col-lg-12">
            <div class="">
                <dl class="row">
                    ...
                    <dt class="col-md-4"><span class="h6 text-md mb-0"><?php echo e(__('Address')); ?></span></dt>
                    ...
                    <dd class="col-md-8"><span class="text-md"><?php echo e(\Auth::user()->dateFormat($lead->start_date)); ?></span></dd>

                    <dt class="col-md-4"><span class="h6 text-md mb-0"><?php echo e(__('End Date')); ?></span></dt>
                    <dd class="col-md-8"><span class="text-md"><?php echo e(\Auth::user()->dateFormat($lead->end_date)); ?></span></dd>
                    ...
                    <dt class="col-md-4"><span class="h6 text-md mb-0"><?php echo e(__('Assigned Staff')); ?></span></dt>
                    <dd class="col-md-8"><span class="text-md"><?php echo e(!empty($lead->assign_user)?$lead->assign_user->name:''); ?> (<?php echo e($lead->assign_user->type); ?>)</span></dd>

                    <dt class="col-md-4"><span class="h6 text-md mb-0"><?php echo e(__('Lead Created')); ?></span></dt>
