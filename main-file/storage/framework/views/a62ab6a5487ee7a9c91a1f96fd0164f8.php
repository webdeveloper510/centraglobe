                        ...
                        <div class="row justify-content-center">
                            ...
                            <?php $__currentLoopData = $collection; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-xxl-3 col-lg-4 col-md-6">
                                    <div
                                        class="card price-card shadow-none  <?php echo e($key == 2 ? 'bg-dark' : ''); ?>">
                                        <div class="card-body">
            ...
            <footer class="site-footer bg-gray-100">
                ...
                <div class="border-top border-dark text-center p-2">
                    ...
                    <p class="mb-0"> &copy;
                        ...
                        <?php echo e(App\Models\Utility::getValByName('footer_text') ? App\Models\Utility::getValByName('footer_text') : config('app.name', 'Salesy Saas')); ?></p>
...
<?php /**PATH C:\xampp\htdocs\centraglobe\main-file\Modules/LandingPage\Resources/views/layouts/landingpage.blade.php ENDPATH**/ ?>