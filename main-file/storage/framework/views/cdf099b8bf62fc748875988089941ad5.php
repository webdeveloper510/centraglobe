<?php 
$venue_rental = unserialize($billingdetail['venue_rental']);
$hotel_rooms = unserialize($billingdetail['hotel_rooms']);
$equipment = unserialize($billingdetail['equipment']);
$setup = unserialize($billingdetail['setup']);
$bar = unserialize($billingdetail['bar']);
$special_req = unserialize($billingdetail['special_req']);
$food = unserialize($billingdetail['food']);
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    <div class="container">
        <form method= "POST" action = "<?php echo e(route('meeting.proposalpdf')); ?>">
            <?php echo csrf_field(); ?>
            <input type="hidden" name="event" value = "<?php echo e($meeting->id); ?>">
            <div class="row">
                <div class="col-md-12">
                    <div class="img-section" style="width:20%; margin: 0 auto;display:flex;">
                            <img class="logo-img" src="<?php echo e(asset('storage/uploads/logo/logo.png')); ?>" style="width:100%; margin:10px auto;display:flex;">
              </div>
                </div>
            </div>
    <div class="row">
    ...
    <div class="row" style="display:flex; border:1px solid black;">
        <div class="col-md-6" style="text-align:left; margin-left:10px;">
            <dl>
                <span style="font-size:14px;margin-bottom:10px;"><?php echo e(__('Name')); ?>: <?php echo e($meeting['name']); ?></span><br>
                <span style="font-size:14px;margin-bottom:10px;"><?php echo e(__('Phone & Email')); ?>: <?php echo e($meeting['phone']); ?> , <?php echo e($meeting['email']); ?></span><br>
                <span style="font-size:14px;margin-bottom:10px;"><?php echo e(__('Address')); ?>: <?php echo e($meeting['lead_address']); ?></span><br>
                <span style="font-size:14px;margin-bottom:10px;"><?php echo e(__('Event Date')); ?>: <?php echo e($meeting['start_date']); ?></span>
            </dl>
        </div>
        <div class="col-md-6" style="text-align:right; margin-top:-9rem;margin-right:20px;">
            <dl class="text-align:left;">
                <span  style="font-size:14px;margin-bottom:10px;"><?php echo e(__('Primary Contact')); ?>: <?php echo e($meeting['name']); ?></span><br>
                <span  style="font-size:14px;margin-bottom:10px;"><?php echo e(__('Phone')); ?>: <?php echo e($meeting['phone']); ?></span><br>
                <span  style="font-size:14px;margin-bottom:10px;"><?php echo e(__('Email')); ?>: <?php echo e($meeting['email']); ?></span><br>
                <span  style="font-size:14px;margin-bottom:10px;"><?php echo e(__('Secondary Contact')); ?>: <?php echo e($meeting['alter_name']); ?></span><br>
                <span  style="font-size:14px;margin-bottom:10px;"><?php echo e(__('Phone')); ?>: <?php echo e($meeting['alter_phone']); ?></span><br>
                <span  style="font-size:14px;margin-bottom:10px;"><?php echo e(__('Email')); ?>: <?php echo e($meeting['alter_email']); ?></span><br>
            </dl>
        </div>
    </div>
    <hr>
    <div class="row" style="display:flex;margin-bottom:10px; border:1px solid black;">
        <div class="col-md-6" style="margin-left:10px;">
            <dl>
                <span style="font-size:14px;margin-bottom:10px;"><?php echo e(__('Deposit')); ?>:</span><br>
                <span style="font-size:14px;margin-bottom:10px;"><?php echo e(__('Billing Method')); ?>:</span>
            </dl>
        </div>
        <div class="col-md-6" style="text-align:right;margin-top:-5rem;margin-right:10px;">
            <dl>
                <span style="font-size:14px;margin-bottom:10px;"><?php echo e(__('Catering Service')); ?>: NA</span><br>
            </dl>
        </div>
    </div>
    <table border="1">
        ...
        <tbody>    
            <tr>
                ...
                <td style="font-size:13px;font-weight:300;padding:8px 0px;"><?php echo e($meeting['meal']); ?></td>
    ...
    <div class="row">
         <div class="col-md-12">
                ...
                <table border="1">
                    <thead>
                        <tr>
                            <th style="text-align:left; font-size:13px;text-align:left; padding:5px 5px; margin-left:5px;">Name : <?php echo e(App\Models\User::where('id',$billingdetail['user_id'])->pluck('name')->first()); ?></th>
                    ...
                    <tbody>    
                        <tr>
                            ...
                            <?php $__currentLoopData = $venue_rental; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <td style="padding:5px 5px; margin-left:5px;font-size:13px;"><?php echo e($value); ?></td>
                                <?php if($key == 'quantity'): ?>
                                <td style="padding:5px 5px; margin-left:5px;font-size:13px;"><?php echo e($total[] = $venue_rental['cost'] * $venue_rental['quantity']); ?></td>
                                <?php endif; ?>
                        ...
                        <tr>
                            ...
                            <td colspan = "2" style="padding:5px 5px; margin-left:5px;font-size:13px;"></td>
                                <?php $__currentLoopData = $food; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <td style="padding:5px 5px; margin-left:5px;font-size:13px;"><?php echo e($value); ?></td>
                                    <?php if($key == 'quantity'): ?>
                                    <td style="padding:5px 5px; margin-left:5px;font-size:13px;"><?php echo e($total[] = $food['cost'] * $food['quantity']); ?></td>
                                    <?php endif; ?>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </tr>
                        <tr>
                            ...
                            <td colspan = "2" style="padding:5px 5px; margin-left:5px;font-size:13px;"></td>
                                <?php $__currentLoopData = $bar; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <td style="padding:5px 5px; margin-left:5px;font-size:13px;"><?php echo e($value); ?></td>
                                    <?php if($key == 'quantity'): ?>
                                    <td style="padding:5px 5px; margin-left:5px;font-size:13px;"><?php echo e($total[] = $bar['cost'] * $bar['quantity']); ?></td>
                                    <?php endif; ?>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </tr>
                        <tr>
                            ...
                            <td colspan = "2" style="padding:5px 5px; margin-left:5px;"></td>
                                <?php $__currentLoopData = $hotel_rooms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <td style="text-align:left;text-align:left; padding:5px 5px; margin-left:5px;font-size:13px;"><?php echo e($value); ?></td>
                                    <?php if($key == 'quantity'): ?>
                                    <td style="padding:5px 5px; margin-left:5px;font-size:13px;"><?php echo e($total[] = $hotel_rooms['cost'] * $hotel_rooms['quantity']); ?></td>
                                    <?php endif; ?>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </tr>
                        <tr>
                            ...
                            <td colspan = "2" style="padding:5px 5px; margin-left:5px;font-size:13px;"></td>
                            <?php $__currentLoopData = $equipment; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <td style="padding:5px 5px; margin-left:5px;font-size:13px;"><?php echo e($value); ?></td>
                            <?php if($key == 'quantity'): ?>
                            <td style="padding:5px 5px; margin-left:5px;font-size:13px;"><?php echo e($total[] =$equipment['cost'] * $equipment['quantity']); ?></td>
                            <?php endif; ?>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </tr>
                        <tr>
                            ...
                            <td style="padding:5px 5px; margin-left:5px;font-size:13px;"><?php echo e($value); ?></td>
                            <?php if($key == 'quantity'): ?>
                            <td style="padding:5px 5px; margin-left:5px;font-size:13px;"><?php echo e($total[] =$setup['cost'] * $setup['quantity']); ?></td>
                            <?php endif; ?>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td colspan = "2" style="padding:5px 5px; margin-left:5px;font-size:13px;"></td>
                            <?php $__currentLoopData = $special_req; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <td style="padding:5px 5px; margin-left:5px;font-size:13px;"><?php echo e($value); ?></td>
                            <?php if($key == 'quantity'): ?>
                            <td style="padding:5px 5px; margin-left:5px;font-size:13px;"><?php echo e($total[] =$special_req['cost'] * $special_req['quantity']); ?></td>
                            <?php endif; ?>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td colspan = "2" style="padding:5px 5px; margin-left:5px;font-size:13px;"></td>
                            <td colspan = "3" style="background-color:#d7e7d7;padding:5px 5px; margin-left:5px;font-size:13px;">$<?php echo e($deposit= $billingdetail['deposit']); ?></td>
                            <td></td>
                        </tr> <tr>
                ...
                Please return signed contract with deposit no later than <input type="date" name="deposit_date" placeholder="_______NA_________"> or this contract is no longer valid.<br>
                </p>
            <p> <strong>** A Deposit of $3000 is already in file.</strong></p>
            <div class="row">
                <div class="col-md-6">
...
</script><?php /**PATH /home/nitin/Desktop/centraglobe/main-file/resources/views/meeting/proposal.blade.php ENDPATH**/ ?>