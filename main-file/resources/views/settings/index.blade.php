                        ...
                        <div class="list-group list-group-flush" id="useradd-sidenav">
                            ...
                            @endif -->
                                ...
                                <a href="#notification-settings"
                                    class="list-group-item list-group-item-action border-0">{{ __('Notification Settings') }} <div
                                        class="float-end"><i class="ti ti-chevron-right"></i></div></a>
                                    ...
                                    <table  class="table align-items-center ">
                                        <thead class="thead-light">
                                            <tr>
                                                ...
                                                <!-- <th scope="col" class="sort" data-sort="username">{{ __('Twilio') }}</th> -->
                                                <th scope="col" class="sort" data-sort="name">{{ __('Email') }}</th>
                                                <th scope="col" class="sort" data-sort="email">{{ __('Push Notification') }}</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                                <tr>
