...
<body>
    <div class="container">
        <form method= "POST" action = "{{route('meeting.proposalpdf')}}">
            @csrf
            <input type="hidden" name="event" value = "{{$meeting->id}}">
            <div class="row">
                <div class="col-md-12">
    ...
    <div class="row">
         <div class="col-md-12">
                ...
                <table border="1">
                    <thead>
                        <tr>
                            <th style="text-align:left; font-size:13px;text-align:left; padding:5px 5px; margin-left:5px;">Name : {{App\Models\User::where('id',$billingdetail['user_id'])->pluck('name')->first()}}</th>
                    ...
                    <tbody>    
                        <tr>
                            ...
                            @foreach($venue_rental as $key => $value)
                            <td style="padding:5px 5px; margin-left:5px;font-size:13px;">{{$value}}</td>
                                @if($key == 'quantity')
                                <td style="padding:5px 5px; margin-left:5px;font-size:13px;">{{$total[] = $venue_rental['cost'] * $venue_rental['quantity']}}</td>
                                @endif
                            @endforeach
                        </tr>
                        ...
                        <tr>
                            ...
                            <td colspan = "2" style="padding:5px 5px; margin-left:5px;font-size:13px;"></td>
                                @foreach($food as $key => $value)
                                    <td style="padding:5px 5px; margin-left:5px;font-size:13px;">{{$value}}</td>
                                    @if($key == 'quantity')
                                    <td style="padding:5px 5px; margin-left:5px;font-size:13px;">{{$total[] = $food['cost'] * $food['quantity']}}</td>
                                    @endif
                                @endforeach
                        </tr>
                        <tr>
                            ...
                            <td colspan = "2" style="padding:5px 5px; margin-left:5px;font-size:13px;"></td>
                                @foreach($bar as  $key => $value)
                                    <td style="padding:5px 5px; margin-left:5px;font-size:13px;">{{$value}}</td>
                                    @if($key == 'quantity')
                                    <td style="padding:5px 5px; margin-left:5px;font-size:13px;">{{$total[] = $bar['cost'] * $bar['quantity']}}</td>
                                    @endif
                                @endforeach
                        </tr>
                        <tr>
                            ...
                            <td colspan = "2" style="padding:5px 5px; margin-left:5px;"></td>
                                @foreach($hotel_rooms as $key => $value)
                                    ...
                                    @if($key == 'quantity')
                                    <td style="padding:5px 5px; margin-left:5px;font-size:13px;">{{$total[] = $hotel_rooms['cost'] * $hotel_rooms['quantity']}}</td>
                                    @endif
                                @endforeach
                        </tr>
                        <tr>
                            ...
                            <td style="padding:5px 5px; margin-left:5px;font-size:13px;">{{$value}}</td>
                            @if($key == 'quantity')
                            <td style="padding:5px 5px; margin-left:5px;font-size:13px;">{{$total[] =$equipment['cost'] * $equipment['quantity']}}</td>
                            @endif
                            @endforeach
                        </tr>
                        <tr>
                            ...
                            <td style="padding:5px 5px; margin-left:5px;font-size:13px;">{{$value}}</td>
                            @if($key == 'quantity')
                            <td style="padding:5px 5px; margin-left:5px;font-size:13px;">{{$total[] =$setup['cost'] * $setup['quantity']}}</td>
                            @endif
                            @endforeach
                        </tr>
                        ...
                        <tr>
                            ...
                            <td colspan = "2" style="padding:5px 5px; margin-left:5px;font-size:13px;"></td>
                            @foreach($special_req as $key => $value)
                            <td style="padding:5px 5px; margin-left:5px;font-size:13px;">{{$value}}</td>
                            @if($key == 'quantity')
                            <td style="padding:5px 5px; margin-left:5px;font-size:13px;">{{$total[] =$special_req['cost'] * $special_req['quantity']}}</td>
                            @endif
                            @endforeach
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td colspan = "2" style="padding:5px 5px; margin-left:5px;font-size:13px;"></td>
                            <td colspan = "3" style="background-color:#d7e7d7;padding:5px 5px; margin-left:5px;font-size:13px;">${{$deposit= $billingdetail['deposit']}}</td>
                            <td></td>
                        </tr> <tr>
